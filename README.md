...
bin/flix test      # 400 tests -- no window, no audio device, no filesystem
bin/flix run       # play
...
400 tests, none of which open a window, an audio device, or the real filesystem — CI enforces
...
| [TestSession](test/TestSession.flix) | 48 | screens, taking turns, typed initials |
