...
bin/flix test      # 396 tests -- no window, no audio device, no filesystem
bin/flix run       # play
...
396 tests, none of which open a window, an audio device, or the real filesystem — CI enforces
...
| [TestSession](test/TestSession.flix) | 44 | screens, taking turns, typed initials |
