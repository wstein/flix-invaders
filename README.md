...
bin/flix test      # 397 tests -- no window, no audio device, no filesystem
bin/flix run       # play
...
397 tests, none of which open a window, an audio device, or the real filesystem — CI enforces
...
| [TestSession](test/TestSession.flix) | 45 | screens, taking turns, typed initials |
