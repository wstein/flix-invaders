...
bin/flix test      # 336 tests -- no window, no audio device, no filesystem
bin/flix run       # play
```
...
336 tests, none of which open a window, an audio device, or the real filesystem — CI enforces
